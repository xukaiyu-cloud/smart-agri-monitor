...
const App = (() => {
  ...
  function renderAlerts(data) {
    ...
    // 去重：同 label 只保留 value 最大的
    ["active","acked","recovered"].forEach(function(st){var its=groups[st]||[];var seen={};var dedup=[];its.forEach(function(a){if(!seen[a.label]){seen[a.label]=a;dedup.push(a);}else if(a.value>seen[a.label].value)seen[a.label]=a;});groups[st]=dedup;});
